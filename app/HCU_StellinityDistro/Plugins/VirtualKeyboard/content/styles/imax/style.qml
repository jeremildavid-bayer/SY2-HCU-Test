...
KeyboardStyle {
    ...
    property color inputLocaleIndicatorColor: colorMap.text02
    property Timer inputLocaleIndicatorHighlightTimer: Timer {
        interval: 500
        onTriggered: inputLocaleIndicatorColor = colorMap.text02
    }
    onInputLocaleChanged: {
        inputLocaleIndicatorColor = colorMap.actionButtonBackground;
    ...
    languageKeyPanel: KeyPanel {
        ...
        Rectangle {
            ...
            ColorOverlay {
                ...
                color: languageKeyPanel.enabled ? colorMap.text01 : colorMap.text02
            }
        }
        states: [
            State {
        ...
        Rectangle {
            ...
            */
            Text {
                ...
                text: {
                    // Translate 'Enter'
                    var locale = InputContext.locale;
                    locale = locale.replace("_", "-");
                    var translated = dsTranslator.translate("T_OK", locale);
                    return translated;
                }
    ...
    shiftKeyPanel: KeyPanel {
        ...
        Rectangle {
            ...
            border.width: ((shiftKeyPanel.state == "disabled") || (shiftKeyBackground.state == "")) ? 0 : 2
            ...
            ColorOverlay {
                id: shiftKeyIconColorOverlay
                anchors.fill: shiftKeyIcon
                source: shiftKeyIcon
                color: ((shiftKeyPanel.state == "disabled") || (shiftKeyBackground.state == "")) ? colorMap.text02 : colorMap.text01
            }
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        ...
                        //color: "#5a892e"
                        color: ((shiftKeyPanel.state == "disabled") || (shiftKeyBackground.state == "")) ? colorMap.keypadButton : colorMap.actionButtonBackground
                    }
                    PropertyChanges {
                        target: shiftKeyIcon
    ...
    spaceKeyPanel: KeyPanel {
        ...
        Rectangle {
            ...
            Text {
                id: spaceKeyText
                text: {
                    if (InputContext.locale === "en_GB")
                    {
                        return "English";
                    }
                    return Qt.locale(InputContext.locale).nativeLanguageName;
                }
